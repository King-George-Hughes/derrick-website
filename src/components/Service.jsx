...
const Service = ({ img, title, message }) => {
  return (
    <div className="bg-white p-5 rounded-xl shadow-md w-full md:w-1/2">
      <div className="relative inline-flex items-center justify-start space-x-5">
      ...
      <p className="text-gray-600 mt-4 max-w-lg leading-6">{message}</p>
    </div>
  );
};
